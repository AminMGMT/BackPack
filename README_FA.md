...
می‌کند؛ روی سرور خارج **Setup Kharej ← Direct ← همان حامل ← Setup Link** را بزن و لینک را پیست کن — توکن، آدرس‌ها و تنظیمات خودکار
می‌آیند. برای چند خارج پشت یک ایران، برای هر خارج یک بار از ایران تونل بساز؛ هر
