...
| **مستقیم** | ایران → خارج | پورت‌های forward‌شده | وقتی اتصال ورودی به ایران رد نمی‌شود |
| **لایه ۳** | هر کدام | کل پکت‌های IP | وقتی یک شبکهٔ خصوصی می‌خواهی، یا پروتکلی که پورت ندارد |

هر سه از **Setup Iran** و **Setup Kharej** ساخته می‌شوند: ماشینی که رویش هستی
را انتخاب کن، ویزارد می‌پرسد کدام جهت را می‌خواهی و خودش کانفیگ را می‌نویسد.

**→ [تونل مستقیم](docs/direct-tunnel.md) · [تونل لایه ۳](docs/l3-direct-tunnel.md)**
