...
func loadServerSpec(name string) (TunnelSpec, error) {
	...
	return TunnelSpec{
		...
		SpoofUplink:      sc.SpoofUplink,
		SpoofDownlink:    sc.SpoofDownlink,
		...
		SpoofMTU:         sc.SpoofMTU,
		SpoofTTLJitter:   sc.SpoofTTLJitter,
		SpoofRandomDSCP:  sc.SpoofRandomDSCP,
		SpoofShufflePort: sc.SpoofShufflePort,
		SpoofPortMin:     sc.SpoofPortMin,
		SpoofPortMax:     sc.SpoofPortMax,
...
func loadClientSpec(name string) (TunnelSpec, error) {
	...
	return TunnelSpec{
		...
		SpoofUplink:      cc.SpoofUplink,
		SpoofDownlink:    cc.SpoofDownlink,
		...
		SpoofPeerSrcIP:   cc.SpoofPeerSrcIP,
		SpoofICMPReply:   cc.SpoofICMPReply,
		SpoofMTU:         cc.SpoofMTU,
		SpoofTTLJitter:   cc.SpoofTTLJitter,
		SpoofRandomDSCP:  cc.SpoofRandomDSCP,
		SpoofShufflePort: cc.SpoofShufflePort,
		SpoofPortMin:     cc.SpoofPortMin,
		SpoofPortMax:     cc.SpoofPortMax,
